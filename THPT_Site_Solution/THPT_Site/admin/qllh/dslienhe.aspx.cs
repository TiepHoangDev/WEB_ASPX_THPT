...
namespace THPT_Site.admin.qllh
{
    public partial class dslienhe : System.Web.UI.Page
    {
        ...
        {
            var lst = new BUS.BUS_LienHe().GetAll();
            if (!string.IsNullOrWhiteSpace(search)) lst = lst.Where(q => q.NguoiGui.ToLower().Contains(search.ToLower())).ToList();
        ...
        protected void grd_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                Label1.Text = new BUS.BUS_LienHe().Delete(Convert.ToInt32(e.CommandArgument.ToString()))
