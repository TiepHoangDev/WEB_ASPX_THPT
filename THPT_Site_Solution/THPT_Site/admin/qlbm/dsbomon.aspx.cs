...
{
    public partial class dsbomon : System.Web.UI.Page
    {
        ...
        {
            var lst = new BUS.BUS_BoMon().GetAll();
            if (!string.IsNullOrWhiteSpace(search)) lst = lst.Where(q => q.TenBM.ToLower().Contains(search)).ToList();
        ...
        protected void grd_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                Label1.Text = new BUS.BUS_BoMon().Delete(Convert.ToInt32(e.CommandArgument.ToString()))
