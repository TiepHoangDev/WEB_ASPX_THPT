<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.Master" AutoEventWireup="true" CodeBehind="bomon.aspx.cs" Inherits="THPT_Site.admin.boMon.bm" %>
        ...
        <tr>
            <td>
                <table cellpadding="5" cellspacing="5" class="auto-style1">
                    ...
                    <tr>
                        <td>Tên bộ môn <span class="auto-style3">(*)</span></td>
                        <td>
                    ...
                    <tr>
                        <td>Trạng thái</td>
                        <td>
                            <asp:CheckBox ID="cbTrangThai" Text="Trạng thái bộ môn" runat="server" Checked="true" />
                        </td>
                    </tr>
                </table>
            </td>
